        ...
        <>
            <div className="deals-countdown  pl-5">
                <span className="countdown-section">
                    ...
                    <span className="countdown-period"> დღე </span>
                </span>
                <span className="countdown-section">
                    <span className="countdown-amount hover-up">
                        {timeParts.hours}
                    </span>
                    <span className="countdown-period"> საათი </span>
                </span>
                <span className="countdown-section">
                    <span className="countdown-amount hover-up">
                        {timeParts.minutes}
                    </span>
                    <span className="countdown-period"> წუთი </span>
                </span>
                <span className="countdown-section">
                    <span className="countdown-amount hover-up">
                        {timeParts.seconds}
                    </span>
                    <span className="countdown-period"> წამი </span>
                </span>
            </div>
        </>
    );
