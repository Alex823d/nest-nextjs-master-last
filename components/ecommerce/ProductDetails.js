                ...
                <div className="row mb-50  mt-30">
                  ...
                  <div className="col-md-6 col-sm-12 col-xs-12">
                    <div className="detail-info  pr-30 pl-30">
                      <span className="stock-status out-stock">ფასდაკლება</span>
                        ...
                        <div className="product-price primary-color float-left">
                          ...
                          <span>
                            <span className="save-price font-md color3 ml-15">
                              {product.discount.percentage}% ფასდაკლება
                            </span>
                      ...
                      <div className="attr-detail attr-color mb-15">
                        <strong className="mr-10">ფერი</strong>
                        <ul className="list-filter color-filter">
                          {product.variations.map((clr, i) => (
                            <li key={i}>
                              <a href="#">
                                <span class={`product-color-${clr}`}></span>
                              </a>
                            </li>
                          ))}
                        </ul>
                      ...
                      <div className="attr-detail attr-size">
                        <strong className="mr-10">ზომა</strong>
