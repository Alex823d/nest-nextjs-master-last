            ...
            <Layout noBreadcrumb="d-none" headerStyle="header-style-1">
                        ...
                        <div className="col-lg-4-5">
                            ...
                            <section className="section-padding pb-5">
                                <div className="section-title" data-wow-delay="0">
                                    <h3 className="">სპეციალური შეთავაზება</h3>
                    ...
                    {/* <div className="container">
                        ...
                        <div className="col-lg-1-5 primary-sidebar sticky-sidebar pt-30">
                            ...
                            <div className="sidebar-widget price_range range mb-30">
                                <h5 className="section-title style-1 mb-30">ფილტრი</h5>
                                ...
                                <div className="list-group">
                                    <div className="list-group-item mb-10 mt-10">
                                        <label className="fw-900">ფილტრი</label>
                                        <VendorFilter />
                            ...
                            <div className="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                                <h5 className="section-title style-1 mb-30">ახალი პროდუქცია</h5>
                                    <div className="bt-1 border-color-1"></div>
                ...
                {/* <section className="popular-categories section-padding">
                    ...
                    <div className="section-title">
                        <div className="title">
                            <h3>აირჩიერთ სასურველი კატეგორია</h3>
                            <Link href="/shop-grid-right"><a className="show-all">
                                ყველა
                                <i className="fi-rs-angle-right"></i>
                            </a></Link>
